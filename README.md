...
This artifact provides the containerized environment used to evaluate the LLM-assisted DNS investigation workflows described in the paper. The deployment has been tested on both Windows and macOS systems.
...
1. Download the artifact ZIP file from the anonymous repository.
